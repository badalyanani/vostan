...
(function() {
    ...
    $(document).on("dblclick", function(event) {
        if (event.target.tagName == "CANVAS" && dblclicked) {
            vostan.toggleMode();
    ...
    var config = {
        ...
        export: true,
        export_full: true,
        draw_link: "projections", // possible values "projections", "centers"
        locales : {
            en: 'eng',
            hy: 'հայ'
        },
        ...
        msg : {
            btn : {
                ...
                copy_settings_full : "Copy layout geometry",
                paste_settings_full : "Paste layout geometry",
        ...
        msg_hy : {
            btn : {
                ...
                copy_settings_full : "Պատճենել դասավորության տեսքը",
                paste_settings_full : "Կիրառել դասավորության տեսքը",
